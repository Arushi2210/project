  ...
  return (
    <>
      ...
      <div className="wholeLoginadvPage" style={{marginTop:"6%"}}>
        <Form style={{borderRadius:"20px",boxShadow:"6px 6px 4px rgba(0, 0, 0, 0.2)", width:"85%"}} className="signInForm" id="signInForm" >
          <center>
            <img
          ...
          <Button style={{fontSize:"75%",marginTop:"2%"}}onClick={ForgotPassword} variant="link" size="sm" id="abc" href="/forgetPassword">
            Forgot Password?
          </Button>
