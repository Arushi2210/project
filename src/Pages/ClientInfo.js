...
export const ClientInfo = ({ clientlist }) => {
  return (
    <div style={{display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <div id = "wholeBody" style={{  flex: 1,paddingRight:"2%",paddingLeft:"2%", overflowY: 'scroll', margin:"0%",paddingTop:"2%"  }}>
      ...
      <div style={{width:"fit-content",padding:"2%",borderRadius:"20px"}}>
